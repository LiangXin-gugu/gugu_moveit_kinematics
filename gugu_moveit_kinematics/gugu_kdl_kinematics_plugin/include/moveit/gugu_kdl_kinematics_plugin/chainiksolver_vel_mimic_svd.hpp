...
#include <moveit/gugu_kdl_kinematics_plugin/joint_mimic.hpp>
#include <Eigen/SVD>
...
public:
  ...
  explicit ChainIkSolverVelMimicSVD(const Chain& chain_,
                                    const std::vector<gugu_kdl_kinematics_plugin::JointMimic>& mimic_joints,
...
private:
  ...
  const std::vector<gugu_kdl_kinematics_plugin::JointMimic>& mimic_joints_;
